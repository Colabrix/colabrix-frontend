...
import { register } from '../services/apis/auth.js';
      ...
      <div className="relative hidden w-[42%] flex-col overflow-hidden bg-primary lg:flex">
        ...
        >
          ...
          <div>
            ...
            >
              Get your team set up in minutes. No credit card required for the 14-day trial.
            </motion.p>

            <motion.div variants={itemVariants} className="mt-10 space-y-4">
              {[
                'Full access to all features during trial',
                'Bring your whole team — up to 5 members free',
                ...
                <div key={point} className="flex items-start gap-3">
                  ...
                  <span className="text-[13px] leading-relaxed text-white/70">{point}</span>
                </div>
              ))}
            </motion.div>
          </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center overflow-y-auto bg-white px-8 py-12">
        ...
        >
          <motion.div variants={itemVariants} className="mb-8">
            <h2 className="text-2xl font-bold text-primary-gray">Create your account</h2>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <motion.div variants={itemVariants} className="pt-1">
              <label className="flex cursor-pointer items-start gap-3">
                <div className="relative mt-0.5">
                  ...
                  <motion.div
                    animate={{
                      backgroundColor: agreed ? '#6366f1' : '#ffffff',
                      borderColor: agreed ? '#6366f1' : '#e2e8f0',
                    }}
                ...
                <span className="text-[13px] leading-relaxed text-secondary-gray">
                  I agree to the{' '}
            ...
            <motion.div variants={itemVariants} className="pt-1">
              <motion.button
                ...
                whileHover={agreed && !loading ? { scale: 1.015 } : {}}
                whileTap={agreed && !loading ? { scale: 0.985 } : {}}
